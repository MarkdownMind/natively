...
export interface ElectronAPI {
  ...
  setNinerouterConfig: (config: { apiKey: string; baseURL: string; maxTokens?: number }) => Promise<{ success: boolean; error?: string }>
